...
>({pageType, items, itemsData}: CardSettingsBarProps<TItems, TItemData>) {
    ...
    return (
        <div
            className="flex items-center justify-between py-[10px] px-[30px] relative border-b border-black border-solid">
            ...
            >
                <div className="flex">
                    ...
                    {isOpenMenu && (
                        <div
                            className="flex flex-col border border-l-transparent border-black border-solid rounded-tr-md bg-white divide-y-[1px] divide-black">
                            <button
                                className="h-1/2 p-1"
                                type="button"
